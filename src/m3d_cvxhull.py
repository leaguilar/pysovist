# /------------------------------------------------------------/
# **3D Volume Calculation Algorithm: 'Convex Hull'**
# -----
...
# sphere-based convex slice, with unobstructed visibility.
# -----
...
## 2. Base Method
def visibility_spherical(pcd_points:o3d.PointCloud, origin:np.ndarray, max_unknown:bool, min_distance = 0, max_distance = 40, num_samples = 1200, **kwargs):
